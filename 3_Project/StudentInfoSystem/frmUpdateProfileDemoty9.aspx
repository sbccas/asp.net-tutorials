<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmUpdateProfileDemoty9.aspx.vb" Inherits="updateProfileDemoty9" MasterPageFile="~/amroli.master" %>
...
<body>
    ...
    <div>
    <h1>UPDATE PROFILE PAGE FOR TYBCA DIV 9 </h1>
      <table>
    <tr>
        <td colspan="3">
            <asp:Label ID="lblTitle" runat="server" 
                Text="PLEASE ENTER YOUR UPDATED DETAILS "></asp:Label>
        </td>
    </tr>
    ...
    <tr>
        <td colspan="3">
            ...
            <asp:LinkButton ID="LinkButton1" runat="server" 
                PostBackUrl="~/frmGridViewDemoTY9.aspx">DISPLAY RECORDS</asp:LinkButton>
        </td>
    </tr>
    <tr>
        <td colspan="3">
